--[[
	...
	Bruhvr Hub by Bruhvr © CC0 1.0 Universal (2023)

	https://github.com/bobking76457564
...
if Bruhvr Hub or Bruhvr Hub Loaded then
    return
end
...
local Aimbot, WallHack = getgenv().Bruhvr Hub.Aimbot, getgenv().Bruhvr Hub.WallHack
...
do
	...
	game.StarterGui:SetCore("SendNotification", {
		Title = "🎆  Bruhvr Hub  🎆",
		Text = "Would you like to use the new Bruhvr Hub script?",
		Button1 = "Yes",
		Button2 = "No",
		Duration = 1 / 0,
